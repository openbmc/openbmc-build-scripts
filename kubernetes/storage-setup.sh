...
###############################################################################
#
# It expects a few variables which are for needed to define PV's
# and PVC's
...
#  NAME		= The name of the PV and PVC that will be used by the 
#		  kubernetes system to refer to PV/PVC
...
#		  The policy, defines what occurs when
#		  claim on PV is released, can be either:
#		  recycle, delete, or retain.
#                 
# Note: Kubernetes Systems  permissions vary by implemtation
