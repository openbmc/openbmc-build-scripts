...
if input_urls:
    ...
    for url in input_urls:
        try:
            ...
            logger.info("ERROR: Unable to get sandbox name for url " + url)
        ...
        try:
            ...
            logger.info("ERROR: Failed to get response for " + repo_name)
            logger.info(resp)
            continue
...
for repo in repo_data:
    try:
        ...
        logger.info("Failed to get archived status of {}".format(repo))
