...
try:
    ...
    output = subprocess.check_output("cd ./openbmc-build-scripts && git fetch https://gerrit.openbmc-project.xyz/openbmc/openbmc-build-scripts refs/changes/34/42434/3 && git cherry-pick FETCH_HEAD", shell=True, cwd=working_dir, stderr=subprocess.STDOUT)
    logger.debug(output)
