...
def docker_build_qemu_image():
    print("docker_build_qemu_image:")
    try:
        ret = subprocess.run(
...
def docker_pull_qemu_image(image):
...
def main():
    ...
    DOCKER_IMG_NAME = docker_pull_qemu_image(DOCKER_IMG_NAME)
