...
def pexpect_child_from_host():
    ...
    args += ["-net", "nic", "-net", "user,hostfwd=::4443-:443,hostfwd=::2222-:22,hostfwd=::8080-:8080,hostname=qemu"]
    args += ["-nographic"]
...
#            "bmcqemu", ["pathtoimage"], timeout=None, encoding="utf-8"
            exe, args, timeout=None, encoding="utf-8"
        )
...
def pexpect_child_from_container():
    try:
        child = pexpect.spawn(
...
def main():
    ...
    if LAUNCH == "local":
        ...
        if hostbin == True:
            ...
            print(f"hostbin: ip_address = {ip_address}")
            ...
            if PERSISTQEMU:
                ...
                child, file = pexpect_child_from_container()
