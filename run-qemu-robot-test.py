...
if os.environ.get("hostbinpersist", "False") != "False":
    print("hostbinpersist True")
    hostbinpersist = True
else:
    print("hostbinpersist False")
    hostbinpersist = False
    ...
    if LAUNCH == "local":
        ...
        if hostbin:
            ...
            if persistentdocker:
                ...
                child, file, execargs = qemu_child_new_container(host_networking_arg(hostnetworking) + rm)
