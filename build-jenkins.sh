...
#                     Default: "2.60.3"
#  juser              Username tag the container will use to run Jenkins
#                     Default: "jenkins"
#  jgroup             Group name tag the container will use to run Jenkins
#                     Default: "jenkins"
#  juid               Jenkins user ID the container will use to run Jenkins
#                     Default: "1000"
#  jgid               Jenkins group ID the container will use to run Jenkins
#                     Default: "1000"
#  jhome              Directory used as the Jenkins Home in the container
#                     Default: "${WORKSPACE}/jenkins_home"
